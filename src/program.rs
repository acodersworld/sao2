...
/// Runs a compiled SAO2 program directly. Standard input, output, and error are
/// inherited so the executable behaves as if the user launched it themselves.
pub fn run(executable: &Path) -> Result<i32, Diagnostic> {
