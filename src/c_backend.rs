...
use crate::ir::{
    self, BinaryOperator, ConstantValue, DefinitionId, DefinitionLayout, FailureSiteId,
    Function, FunctionId, IntegerOperation, Intrinsic, LocalId, NumericConversion,
...
impl<'a> Renderer<'a> {
    ...
    fn render_scalar_helpers(&mut self) {
        self.output.push_str(concat!(
            ...
            "    _Static_assert(sizeof(double) == sizeof bits, \"SAO2 requires 64-bit double\");\n",
            "    double value;\n",
            ...
            "}\n\n",
            "void sao2_check_integer_add(int64_t, int64_t, size_t);\n",
            "void sao2_check_integer_subtract(int64_t, int64_t, size_t);\n",
            "void sao2_check_integer_multiply(int64_t, int64_t, size_t);\n",
            "void sao2_check_shift_left(int64_t, int64_t, size_t);\n",
            "void sao2_check_integer_negation(int64_t, size_t);\n",
            "void sao2_check_division_int(int64_t, int64_t, size_t);\n",
            "void sao2_check_division_float(double, double, size_t);\n",
            "void sao2_check_remainder(int64_t, int64_t, size_t);\n",
            "void sao2_check_shift_range(int64_t, size_t);\n",
            "void sao2_check_finite_float(double, size_t);\n",
            "void sao2_check_float_to_int(double, size_t);\n",
            "_Noreturn void sao2_compiler_invariant(void);\n",
            "_Noreturn void sao2_panic(sao2_string, size_t);\n",
            "_Noreturn void sao2_error_panic_int(int64_t, size_t);\n",
            "_Noreturn void sao2_error_panic_bool(bool, size_t);\n",
            "_Noreturn void sao2_error_panic_char(uint8_t, size_t);\n\n",
            ...
            "static volatile size_t sao2_output_failure_site;\n\n",
            "static _Noreturn void sao2_output_failure(size_t site) {\n",
            "    sao2_output_failure_site = site; /* Stage 3 replaces this temporary failure path. */\n",
            "    exit(EXIT_FAILURE);\n",
            "}\n\n",
...
mod tests {
    ...
    #[test]
    fn renders_temporary_output_with_exact_failure_sites_and_windows_guard() {
        let (mut program, types, location) = program();
        let failure = program.intern_failure_site(FailureSite {
            location,
            function: FunctionId::from_index(0),
